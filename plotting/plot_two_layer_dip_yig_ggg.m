 %% plot results 
      ...
      data_dir = ['C:\Users\samry\Documents\MATLAB\Elastic\magnetoelastics_paper\data_v2\double_layer_dip_yig_ggg_N_12.mat'];
...
axes('Position',[ml,mb,spanx,spany]);
 ...
 axis([3.52*10^8 4*10^8 200*10^9 258*10^9]/10^9)
...
print(fh,'-dpdf','two_layer_dip_yig_ggg_N_12.pdf');